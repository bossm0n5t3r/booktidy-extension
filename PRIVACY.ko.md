...
규칙 메타데이터는 규칙 식별자, 규칙 활성화 여부, 매칭 방식, 생성 시각, 수정 시각을 포함할 수 있습니다.
...
BookTidy는 서버 API, analytics, 원격 동기화, 외부 데이터 전송을 사용하지 않습니다. 규칙과 설정은 사용자의 Firefox 로컬 확장 저장소에만 남습니다.
...
BookTidy는 사용자의 계정, 구매 내역, 추천 정보, 원격 웹사이트 데이터를 수정하지 않습니다.
